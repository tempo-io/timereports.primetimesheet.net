describe('timesheetControllerTest', function () {
  ...
  var checkOptions = function (scope) {
    ...
    expect(scope.groupByOptions.options.length).toBe(scope.pivotTableType === 'TimeTracking' ? 39 : scope.pivotTableType === 'IssueWorkedTimeByUser' ? 46 : 45)
  ...
  beforeEach(function () {
    ...
    angular.module('timesheetApp').service('flightRecorder', function () {
      ...
      return {
        ...
        dateFields: { val: [] },
        disableLogWork: {},
        disableLogWorkProjects: {},
        disableLogWorkGroups: {},
        restrictWorkPerDay: {},
        workUnderLimitColor: {},
        workOverLimitColor: {},
        limitPrecision: {},
