...
QUnit.test("Html Export Timesheet", function() {
    ...
    QUnit.assert.equal(header, "<td>Issue Type</td><td>Parent</td><td>Key</td><td>Summary</td><td>Priority</td><td>Work Description</td><td>24/Feb</td><td>25/Feb</td><td>26/Feb</td><td>27/Feb</td><td>28/Feb</td><td>Total</td>", "header");
...
QUnit.test("Html Export Timesheet Grouped by Worked User More Fields", function() {
    ...
    QUnit.assert.equal(row1, "<td><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a> (6 issues)</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>48</td><td>81</td><td>9</td><td>13</td><td>0</td><td>13</td><td>13</td><td>48</td>", "row1");
...
QUnit.test("Html Export Timesheet More Fields", function() {
    ...
    var lines = html.split('\n');
    var header = lines.slice(10, 25).map(s => s.trim()).join('');
    QUnit.assert.equal(header, "<td>Issue Type</td><td>Parent</td><td>Key</td><td>Summary</td><td>Priority</td><td>Assignee</td><td>Timespent</td><td>Estimate</td><td>Work Description</td><td>24/Feb</td><td>25/Feb</td><td>26/Feb</td><td>27/Feb</td><td>28/Feb</td><td>Total</td>", "header");
    var row1 = lines.slice(27, 42).map(s => s.trim()).join('');
    QUnit.assert.equal(row1,
        "<td>Bug</td><td></td><td><a href='/browse/TIME-1'>TIME-1</a></td><td><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td>Major</td><td><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td>11</td><td>44</td><td>&nbsp</td><td>8</td><td>3</td><td>0</td><td>0</td><td>0</td><td>11</td>", "row1");
    var row2 = lines.slice(44, 59).map(s => s.trim()).join('');
...
QUnit.test("Html Export Pivot by User Grouped by Issue Itself More Fields", function() {
    ...
    var lines = html.split('\n');
    var header = lines.slice(10, 22).map(s => s.trim()).join('');
    QUnit.assert.equal(header, "<td>Issue itself</td><td>Issue Type</td><td>Parent</td><td>Key</td><td>Summary</td><td>Priority</td><td>Assignee</td><td>Timespent</td><td>Estimate</td><td>Work Description</td><td><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td>Total</td>", "header");
    var row1 = lines.slice(24, 36).map(s => s.trim()).join('');
    // FIXME: issue type, key, summary, priority
    QUnit.assert.equal(row1, "<td><a href='/browse/TIME-1' title='Hocus Focus Problem'>TIME-1 Hocus Focus Problem</a> (1 issue)</td><td>Bug</td><td></td><td><a href='/browse/TIME-1'>TIME-1</a></td><td><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td>Major</td><td><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td>11</td><td>44</td><td>&nbsp</td><td>11</td><td>11</td>", "row1");
    var row2 = lines.slice(38, 50).map(s => s.trim()).join('');
...
QUnit.test("Html Export TimeTracking Grouped by Assignee", function() {
    ...
    var row1 = lines.slice(24, 36).map(s => s.trim()).join('');
    QUnit.assert.equal(row1, "<td><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a> (6 issues)</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>73.78</td><td>33</td><td>48</td><td>-7.22</td><td>25.78</td><td>59%</td>", "row1");
    var row2 = lines.slice(38, 50).map(s => s.trim()).join('');
