...
QUnit.test("Html Export Timesheet Grouped by Worked User More Fields", function() {
    ...
    QUnit.assert.equal(row1, "<td class='nav border'><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a> (6 issues)</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>48</td><td class='nav border'>81</td><td class='nav border'>&nbsp</td><td class='nav border'>9</td><td class='nav border'>13</td><td class='nav border'>0</td><td class='nav border'>13</td><td class='nav border'>13</td><td class='nav border total'>48</td>", "row1");
    var row2 = lines.slice(46, 62).map(s => s.trim()).join('');
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>11</td><td class='nav border'>44</td><td class='nav border'>test 7</td><td class='nav border'>&nbsp;</td><td class='nav border'>3</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td>", "row2");
    var total = lines.slice(/* 18*14 + 10 */ 262, 278).map(s => s.trim()).join('');
    QUnit.assert.equal(total, "<td class='nav border total'>Total (6 issues)</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>48</td><td class='nav border total'>81</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>9</td><td class='nav border total'>13</td><td class='nav border total'>0</td><td class='nav border total'>13</td><td class='nav border total'>13</td><td class='nav border total'>48</td>", "total");
