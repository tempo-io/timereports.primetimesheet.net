QUnit.test('Excel Export', function () {
  ...
  var excel = excelView.generate({ pivotTableType: 'Timesheet',
...
QUnit.test('Excel Export TimeTracking', function () {
  var excelView = new ExcelView(TimeData.issues)
  QUnit.assert.equal(typeof excelView, 'object', 'excelView')
  var excel = excelView.generate({ pivotTableType: 'TimeTracking',
    startDate: '2014-02-24',
    reportingDay: 1,
    moreFields: [],
    translations: translations,
...
QUnit.test('Excel Export TimeBalance', function () {
  var excelView = new ExcelView(TimeData.issues)
  QUnit.assert.equal(typeof excelView, 'object', 'excelView')
  var excel = excelView.generate({ pivotTableType: 'TimeBalance',
    startDate: '2014-02-24',
    reportingDay: 1,
    moreFields: [],
    translations: translations,
...
QUnit.test('Csv Export', function () {
  ...
  var csv = csvView.generate({ pivotTableType: 'Timesheet',
    startDate: '2014-02-24',
    reportingDay: 1,
    moreFields: [],
    translations: translations,
...
QUnit.test('Csv Export TimeTracking', function () {
  var csvView = new CsvView(TimeData.issues)
  QUnit.assert.equal(typeof csvView, 'object', 'csvView')
  var csv = csvView.generate({ pivotTableType: 'TimeTracking',
    startDate: '2014-02-24',
    reportingDay: 1,
    moreFields: [],
    translations: translations,
...
QUnit.test('Csv Export TimeBalance', function () {
  var csvView = new CsvView(TimeData.issues)
  QUnit.assert.equal(typeof csvView, 'object', 'csvView')
  var csv = csvView.generate({ pivotTableType: 'TimeBalance',
    startDate: '2014-02-24',
    reportingDay: 1,
    moreFields: [],
    translations: translations,
...
QUnit.test('Html Export Timesheet', function () {
  ...
  var html = htmlView.generate({ pivotTableType: 'Timesheet',
    startDate: '2014-02-24',
    reportingDay: 1,
    moreFields: [],
    translations: translations,
  ...
  QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>&nbsp</td><td class='nav border'>8h</td><td class='nav border'>3h</td><td class='nav border'></td><td class='nav border'></td><td class='nav border'></td><td class='nav border total'>11h</td>", 'row1')
...
QUnit.test('Html Export Timesheet Compressed', function () {
  var htmlView = new HtmlView(TimeData.issues)
  QUnit.assert.equal(typeof htmlView, 'object', 'excelView')
  var html = htmlView.generate({ compressed: true,
  ...
  var row1 = lines.slice(23, 34).map(s => s.trim()).join('')
  QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>8h</td><td class='nav border'>3h</td><td class='nav border'></td><td class='nav border'></td><td class='nav border'></td><td class='nav border total'>11h</td>", 'row1')
  var row2 = lines.slice(36, 47).map(s => s.trim()).join('')
  QUnit.assert.equal(row2, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-2'>TIME-2</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-2'>Loch Ness Monster Bug</a></td><td class='nav border'>Major</td><td class='nav border'></td><td class='nav border'>5h</td><td class='nav border'></td><td class='nav border'>8h</td><td class='nav border'></td><td class='nav border total'>13h</td>", 'row2')
...
QUnit.test('Html Export IssueWorkedTimeByLabel Compressed', function () {
  ...
  QUnit.assert.equal(typeof htmlView, 'object', 'excelView')
  var html = htmlView.generate({ compressed: true,
    pivotTableType: 'IssueWorkedTimeByLabel',
    startDate: '2014-02-24',
    reportingDay: 1,
    moreFields: [],
    translations: translations,
  ...
  var row1 = lines.slice(21, 30).map(s => s.trim()).join('')
  QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>3h</td><td class='nav border'></td><td class='nav border'>8h</td><td class='nav border total'>11h</td>", 'row1')
  var row2 = lines.slice(32, 41).map(s => s.trim()).join('')
  QUnit.assert.equal(row2, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-2'>TIME-2</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-2'>Loch Ness Monster Bug</a></td><td class='nav border'>Major</td><td class='nav border'>8h</td><td class='nav border'>5h</td><td class='nav border'></td><td class='nav border total'>13h</td>", 'row2')
...
QUnit.test('Html Export Timesheet Grouped by Worked User More Fields', function () {
  ...
  var html = htmlView.generate({ categorizeByField: 'assignee',
...
QUnit.test('Html Export Timesheet More Fields', function () {
  ...
  QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'><a target='_blank' href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'>11h</td><td class='nav border'>44h</td><td class='nav border'>&nbsp</td><td class='nav border'>8h</td><td class='nav border'>3h</td><td class='nav border'></td><td class='nav border'></td><td class='nav border'></td><td class='nav border total'>11h</td>", 'row1')
...
QUnit.test('Html Export Pivot by User Grouped by Issue Itself More Fields', function () {
  ...
  moreFieldsOptions.addOption('Time Spent', 'timespent')
  moreFieldsOptions.addOption('Estimate', 'timetrackingestimate')
  var html = htmlView.generate({ groupByField: 'issue',
  ...
  var lines = html.split('\n')
  var header = lines.slice(10, 22).map(s => s.trim()).join('')
  QUnit.assert.equal(header, "<td class='nav border total'>Issue itself</td><td class='nav border total'>Issue Type</td><td class='nav border total'>Parent</td><td class='nav border total'>Key</td><td class='nav border total'>Summary</td><td class='nav border total'>Priority</td><td class='nav border total'>Assignee</td><td class='nav border total'>Time Spent</td><td class='nav border total'>Estimate</td><td class='nav border total'>Work Description</td><td class='nav border total'><a target='_blank' href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border total'>Total</td>", 'header')
  var row1 = lines.slice(24, 36).map(s => s.trim()).join('')
  // FIXME: issue type, key, summary, priority
  QUnit.assert.equal(row1, "<td class='nav border'><a target='_blank' href='/browse/TIME-1' title='Hocus Focus Problem'>TIME-1 Hocus Focus Problem</a> (1 issue)</td><td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'><a target='_blank' href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'>11h</td><td class='nav border'>44h</td><td class='nav border'>&nbsp</td><td class='nav border'>11h</td><td class='nav border total'>11h</td>", 'row1')
  var row2 = lines.slice(38, 50).map(s => s.trim()).join('')
...
QUnit.test('Html Export TimeTracking', function () {
  var htmlView = new HtmlView(TimeData.issues)
  QUnit.assert.equal(typeof htmlView, 'object', 'excelView')
  var html = htmlView.generate({ pivotTableType: 'TimeTracking',
    startDate: '2014-02-24',
    reportingDay: 1,
    moreFields: [],
    timeTrackingColumns: [
  ...
  var row1 = lines.slice(23, 34).map(s => s.trim()).join('')
  QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'></td><td class='nav border'>33h</td><td class='nav border'>11h</td><td class='nav border'>-44h</td><td class='nav border'>-11h</td><td class='nav border'>25%</td>", 'row1')
  var row2 = lines.slice(36, 47).map(s => s.trim()).join('')
  QUnit.assert.equal(row2, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-2'>TIME-2</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-2'>Loch Ness Monster Bug</a></td><td class='nav border'>Major</td><td class='nav border'>26h</td><td class='nav border'></td><td class='nav border'>13h</td><td class='nav border'>13h</td><td class='nav border'>13h</td><td class='nav border'>100%</td>", 'row2')
...
QUnit.test('Html Export TimeTracking Grouped by Assignee', function () {
  var htmlView = new HtmlView(TimeData.issues)
  QUnit.assert.equal(typeof htmlView, 'object', 'excelView')
  var html = htmlView.generate({ groupByField: 'assignee',
