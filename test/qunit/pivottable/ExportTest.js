...
QUnit.test('Html Export Timesheet', function (assert) {
  ...
  $html.then(html => {
    ...
    QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border' nowrap></td><td class='nav border' nowrap><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>&nbsp</td><td class='nav border'>8</td><td class='nav border'>3</td><td class='nav border'></td><td class='nav border'></td><td class='nav border'></td><td class='nav border total'>11</td>", 'row1')
    var row2 = lines.slice(38, 50).map(s => s.trim()).join('')
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>test 8 #tag8</td><td class='nav border'>8</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td>", 'row2')
    var total = lines.slice(/* 14*19 + 10 */ 276, 284).map(s => s.trim()).join('')
    QUnit.assert.equal(total, "<th class='nav border total' colspan=5>Total</th><th class='nav border total'>&nbsp;</th><th class='nav border total'>9</th><th class='nav border total'>13</th><th class='nav border total'></th><th class='nav border total'>13</th><th class='nav border total'>13</th><th class='nav border total'>48</th>", 'total')
...
QUnit.test('Html Export Timesheet Compressed', function (assert) {
  ...
  $html.then(html => {
    ...
    var row1 = lines.slice(23, 34).map(s => s.trim()).join('')
    QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border' nowrap></td><td class='nav border' nowrap><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>8</td><td class='nav border'>3</td><td class='nav border'></td><td class='nav border'></td><td class='nav border'></td><td class='nav border total'>11</td>", 'row1')
    var row2 = lines.slice(36, 47).map(s => s.trim()).join('')
    QUnit.assert.equal(row2, "<td class='nav border'>Bug</td><td class='nav border' nowrap></td><td class='nav border' nowrap><a target='_blank' href='/browse/TIME-2'>TIME-2</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-2'>Loch Ness Monster Bug</a></td><td class='nav border'>Major</td><td class='nav border'></td><td class='nav border'>5</td><td class='nav border'></td><td class='nav border'>8</td><td class='nav border'></td><td class='nav border total'>13</td>", 'row2')
    var total = lines.slice(/* 13*7 + 10 */ 101, 108).map(s => s.trim()).join('')
    QUnit.assert.equal(total, "<th class='nav border total' colspan=5>Total</th><th class='nav border total'>9</th><th class='nav border total'>13</th><th class='nav border total'></th><th class='nav border total'>13</th><th class='nav border total'>13</th><th class='nav border total'>48</th>", 'total')
...
QUnit.test('Html Export IssueWorkedTimeByLabel Compressed', function (assert) {
  ...
  $html.then(html => {
    ...
    var row1 = lines.slice(21, 30).map(s => s.trim()).join('')
    QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border' nowrap></td><td class='nav border' nowrap><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>3</td><td class='nav border'></td><td class='nav border'>8</td><td class='nav border total'>11</td>", 'row1')
    var row2 = lines.slice(32, 41).map(s => s.trim()).join('')
    QUnit.assert.equal(row2, "<td class='nav border'>Bug</td><td class='nav border' nowrap></td><td class='nav border' nowrap><a target='_blank' href='/browse/TIME-2'>TIME-2</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-2'>Loch Ness Monster Bug</a></td><td class='nav border'>Major</td><td class='nav border'>8</td><td class='nav border'>5</td><td class='nav border'></td><td class='nav border total'>13</td>", 'row2')
    var total = lines.slice(87, 92).map(s => s.trim()).join('')
    QUnit.assert.equal(total, "<th class='nav border total' colspan=5>Total</th><th class='nav border total'>35</th><th class='nav border total'>5</th><th class='nav border total'>8</th><th class='nav border total'>48</th>", 'total')
...
QUnit.test('Html Export Timesheet Grouped by Worked User More Fields', function (assert) {
  ...
  $html.then(html => {
    ...
    QUnit.assert.equal(row1, "<td class='nav border'><a target='_blank' href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'><a target='_blank' href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>48</td><td class='nav border'>81</td><td class='nav border'>&nbsp</td><td class='nav border'>9</td><td class='nav border'>13</td><td class='nav border'></td><td class='nav border'>13</td><td class='nav border'>13</td><td class='nav border total'>48</td>", 'row1')
    var row2 = lines.slice(46, 62).map(s => s.trim()).join('')
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>11</td><td class='nav border'>44</td><td class='nav border'>test 8 #tag8</td><td class='nav border'>8</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td>", 'row2')
    var total = lines.slice(/* 18*14 + 10 */ 262, 272).map(s => s.trim()).join('')
    QUnit.assert.equal(total, "<th class='nav border total' colspan=7>Total</th><th class='nav border total'>48</th><th class='nav border total'>81</th><th class='nav border total'>&nbsp;</th><th class='nav border total'>9</th><th class='nav border total'>13</th><th class='nav border total'></th><th class='nav border total'>13</th><th class='nav border total'>13</th><th class='nav border total'>48</th>", 'total')
...
QUnit.test('Html Export Timesheet More Fields', function (assert) {
  ...
  $html.then(html => {
    ...
    QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border' nowrap></td><td class='nav border' nowrap><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'><a target='_blank' href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'>11</td><td class='nav border'>44</td><td class='nav border'>&nbsp</td><td class='nav border'>8</td><td class='nav border'>3</td><td class='nav border'></td><td class='nav border'></td><td class='nav border'></td><td class='nav border total'>11</td>", 'row1')
    var row2 = lines.slice(44, 59).map(s => s.trim()).join('')
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>test 8 #tag8</td><td class='nav border'>8</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td>", 'row2')
    var total = lines.slice(/* 17*19 + 10 */ 333, 344).map(s => s.trim()).join('')
    QUnit.assert.equal(total, "<th class='nav border total' colspan=5>Total</th><th class='nav border total'></th><th class='nav border total'>48</th><th class='nav border total'>81</th><th class='nav border total'>&nbsp;</th><th class='nav border total'>9</th><th class='nav border total'>13</th><th class='nav border total'></th><th class='nav border total'>13</th><th class='nav border total'>13</th><th class='nav border total'>48</th>", 'total')
...
QUnit.test('Html Export Pivot by User Grouped by Issue Itself More Fields', function (assert) {
  ...
  $html.then(html => {
    ...
    QUnit.assert.equal(row1, "<td class='nav border'><a target='_blank' href='/browse/TIME-1' title='Hocus Focus Problem'>TIME-1 Hocus Focus Problem</a></td><td class='nav border'>Bug</td><td class='nav border' nowrap></td><td class='nav border' nowrap><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'><a target='_blank' href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'>11</td><td class='nav border'>44</td><td class='nav border'>&nbsp</td><td class='nav border'>11</td><td class='nav border total'>11</td>", 'row1')
    var row2 = lines.slice(38, 50).map(s => s.trim()).join('')
    // FIXME: worklog comment
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>test 8 #tag8</td><td class='nav border'>8</td><td class='nav border'>&nbsp;</td>", 'row2')
    var total = lines.slice(/* 14*19 + 10 */ 276, 283).map(s => s.trim()).join('')
    QUnit.assert.equal(total, "<th class='nav border total' colspan=6>Total</th><th class='nav border total'></th><th class='nav border total'>48</th><th class='nav border total'>81</th><th class='nav border total'>&nbsp;</th><th class='nav border total'>48</th><th class='nav border total'>48</th>", 'total')
...
QUnit.test('Html Export TimeTracking', function (assert) {
  ...
  $html.then(html => {
    ...
    var lines = html.split('\n')
    var header = lines.slice(10, 21).map(s => s.trim()).join('')
    QUnit.assert.equal(header, "<th class='nav border total'>Issue Type</th><th class='nav border total'>Parent</th><th class='nav border total'>Key</th><th class='nav border total'>Summary</th><th class='nav border total'>Priority</th><th class='nav border total'>Original Estimate (h)</th><th class='nav border total'>Est. Time Remaining (h)</th><th class='nav border total'>Time Spent (h)</th><th class='nav border total'>Variance (h)</th><th class='nav border total'>Original Estimate Remaining (h)</th><th class='nav border total'>Progress</th>", 'header')
    var row1 = lines.slice(23, 34).map(s => s.trim()).join('')
    QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border' nowrap></td><td class='nav border' nowrap><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'></td><td class='nav border'>33</td><td class='nav border'>11</td><td class='nav border'>-44</td><td class='nav border'>-11</td><td class='nav border'>25%</td>", 'row1')
    var row2 = lines.slice(36, 47).map(s => s.trim()).join('')
    QUnit.assert.equal(row2, "<td class='nav border'>Bug</td><td class='nav border' nowrap></td><td class='nav border' nowrap><a target='_blank' href='/browse/TIME-2'>TIME-2</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-2'>Loch Ness Monster Bug</a></td><td class='nav border'>Major</td><td class='nav border'>26</td><td class='nav border'></td><td class='nav border'>13</td><td class='nav border'>13</td><td class='nav border'>13</td><td class='nav border'>100%</td>", 'row2')
    var total = lines.slice(/* 13*7 + 10 */ 101, 108).map(s => s.trim()).join('')
    QUnit.assert.equal(total, "<th class='nav border total' colspan=5>Total</th><th class='nav border total'>73.78</th><th class='nav border total'>33</th><th class='nav border total'>48</th><th class='nav border total'>-7.22</th><th class='nav border total'>25.78</th><th class='nav border total'>59%</th>", 'total')
    QUnit.assert.equal(lines.length, 13 * 8 + 6 + 1 /* new line at end of file */, 'lines')
    done()
  })
})
QUnit.test('Html Export TimeTracking Grouped by Assignee', function (assert) {
  ...
  $html.then(html => {
    ...
    var row1 = lines.slice(24, 36).map(s => s.trim()).join('')
    QUnit.assert.equal(row1, "<td class='nav border'><a target='_blank' href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>73.78</td><td class='nav border'>33</td><td class='nav border'>48</td><td class='nav border'>-7.22</td><td class='nav border'>25.78</td><td class='nav border'>59%</td>", 'row1')
    var row2 = lines.slice(38, 50).map(s => s.trim()).join('')
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a target='_blank' href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'></td><td class='nav border'>33</td><td class='nav border'>11</td><td class='nav border'>-44</td><td class='nav border'>-11</td><td class='nav border'>25%</td>", 'row2')
    var total = lines.slice(/* 14*8 + 10 */ 122, 129).map(s => s.trim()).join('')
    QUnit.assert.equal(total, "<th class='nav border total' colspan=6>Total</th><th class='nav border total'>73.78</th><th class='nav border total'>33</th><th class='nav border total'>48</th><th class='nav border total'>-7.22</th><th class='nav border total'>25.78</th><th class='nav border total'>59%</th>", 'total')
...
QUnit.test('Pdf Export Cost Report', function (assert) {
  ...
  $pdf.then(pdf => {
    ...
    QUnit.assert.equal(row2, ',test 8 #tag8,8h,10,80', 'row2')
