...
QUnit.test("Html Export Timesheet", function() {
    ...
    QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>&nbsp</td><td class='nav border'>8</td><td class='nav border'>3</td><td class='nav border'>0</td><td class='nav border'>0</td><td class='nav border'>0</td><td class='nav border total'>11</td>", "row1");
    var row2 = lines.slice(38, 50).map(s => s.trim()).join('');
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>test 7</td><td class='nav border'>&nbsp;</td><td class='nav border'>3</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td>", "row2");
    var total = lines.slice(/* 14*19 + 10 */ 276, 288).map(s => s.trim()).join('');
    QUnit.assert.equal(total, "<td class='nav border total'>Total (6 issues)</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>9</td><td class='nav border total'>13</td><td class='nav border total'>0</td><td class='nav border total'>13</td><td class='nav border total'>13</td><td class='nav border total'>48</td>", "total");
...
QUnit.test("Html Export Timesheet Compressed", function() {
    ...
    var row1 = lines.slice(23, 34).map(s => s.trim()).join('');
    QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>8</td><td class='nav border'>3</td><td class='nav border'>0</td><td class='nav border'>0</td><td class='nav border'>0</td><td class='nav border total'>11</td>", "row1");
    var row2 = lines.slice(36, 47).map(s => s.trim()).join('');
    QUnit.assert.equal(row2, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-2'>TIME-2</a></td><td class='nav border'><a href='/browse/TIME-2'>Loch Ness Monster Bug</a></td><td class='nav border'>Major</td><td class='nav border'>0</td><td class='nav border'>5</td><td class='nav border'>0</td><td class='nav border'>8</td><td class='nav border'>0</td><td class='nav border total'>13</td>", "row2");
    var total = lines.slice(/* 13*7 + 10 */ 101, 111).map(s => s.trim()).join('');
    QUnit.assert.equal(total, "<td class='nav border total'>Total (6 issues)</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>9</td><td class='nav border total'>13</td><td class='nav border total'>0</td><td class='nav border total'>13</td><td class='nav border total'>13</td>", "total");
...
QUnit.test("Html Export Timesheet Grouped by Worked User More Fields", function() {
    ...
    QUnit.assert.equal(header, "<td class='nav border total'>Assignee</td><td class='nav border total'>Worked User</td><td class='nav border total'>Issue Type</td><td class='nav border total'>Parent</td><td class='nav border total'>Key</td><td class='nav border total'>Summary</td><td class='nav border total'>Priority</td><td class='nav border total'>Time Spent</td><td class='nav border total'>Estimate</td><td class='nav border total'>24/Feb</td><td class='nav border total'>25/Feb</td><td class='nav border total'>26/Feb</td><td class='nav border total'>27/Feb</td><td class='nav border total'>28/Feb</td><td class='nav border total'>Total</td>", "header");
    var row1 = lines.slice(27, 42).map(s => s.trim()).join('');
    QUnit.assert.equal(row1, "<td class='nav border'><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a> (6 issues)</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>48</td><td class='nav border'>81</td><td class='nav border'>9</td><td class='nav border'>13</td><td class='nav border'>0</td><td class='nav border'>13</td><td class='nav border'>13</td><td class='nav border total'>48</td>", "row1");
    var row2 = lines.slice(44, 59).map(s => s.trim()).join('');
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>11</td><td class='nav border'>44</td><td class='nav border'>&nbsp;</td><td class='nav border'>3</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td>", "row2");
    var total = lines.slice(/* 17*14 + 10 */ 248, 263).map(s => s.trim()).join('');
    QUnit.assert.equal(total, "<td class='nav border total'>Total (6 issues)</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>48</td><td class='nav border total'>81</td><td class='nav border total'>9</td><td class='nav border total'>13</td><td class='nav border total'>0</td><td class='nav border total'>13</td><td class='nav border total'>13</td><td class='nav border total'>48</td>", "total");
...
QUnit.test("Html Export Timesheet More Fields", function() {
    ...
    var row1 = lines.slice(27, 42).map(s => s.trim()).join('');
    QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'>11</td><td class='nav border'>44</td><td class='nav border'>&nbsp</td><td class='nav border'>8</td><td class='nav border'>3</td><td class='nav border'>0</td><td class='nav border'>0</td><td class='nav border'>0</td><td class='nav border total'>11</td>", "row1");
    var row2 = lines.slice(44, 59).map(s => s.trim()).join('');
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>test 7</td><td class='nav border'>&nbsp;</td><td class='nav border'>3</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td>", "row2");
    var total = lines.slice(/* 17*19 + 10 */ 333, 348).map(s => s.trim()).join('');
    QUnit.assert.equal(total, "<td class='nav border total'>Total (6 issues)</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'></td><td class='nav border total'>48</td><td class='nav border total'>81</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>9</td><td class='nav border total'>13</td><td class='nav border total'>0</td><td class='nav border total'>13</td><td class='nav border total'>13</td><td class='nav border total'>48</td>", "total");
...
QUnit.test("Html Export Pivot by User Grouped by Issue Itself More Fields", function() {
    ...
    QUnit.assert.equal(row1, "<td class='nav border'><a href='/browse/TIME-1' title='Hocus Focus Problem'>TIME-1 Hocus Focus Problem</a> (1 issue)</td><td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a></td><td class='nav border'>11</td><td class='nav border'>44</td><td class='nav border'>&nbsp</td><td class='nav border'>11</td><td class='nav border total'>11</td>", "row1");
    var row2 = lines.slice(38, 50).map(s => s.trim()).join('');
    // FIXME: worklog comment
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>test 7</td><td class='nav border'>3</td><td class='nav border'>&nbsp;</td>", "row2");
    var total = lines.slice(/* 14*19 + 10 */ 276, 288).map(s => s.trim()).join('');
    QUnit.assert.equal(total, "<td class='nav border total'>Total (6 issues)</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'></td><td class='nav border total'>48</td><td class='nav border total'>81</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>48</td><td class='nav border total'>48</td>", "total");
    QUnit.assert.equal(lines.length, 14*20 + 10 + 1 /* new line at end of file */, "lines");
});
QUnit.test("Html Export TimeTracking", function() {
    ...
    var row1 = lines.slice(23, 34).map(s => s.trim()).join('');
    QUnit.assert.equal(row1, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>0</td><td class='nav border'>33</td><td class='nav border'>11</td><td class='nav border'>-44</td><td class='nav border'>-11</td><td class='nav border'>25%</td>", "row1");
    var row2 = lines.slice(36, 47).map(s => s.trim()).join('');
    QUnit.assert.equal(row2, "<td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-2'>TIME-2</a></td><td class='nav border'><a href='/browse/TIME-2'>Loch Ness Monster Bug</a></td><td class='nav border'>Major</td><td class='nav border'>26</td><td class='nav border'>0</td><td class='nav border'>13</td><td class='nav border'>13</td><td class='nav border'>13</td><td class='nav border'>100%</td>", "row2");
    var total = lines.slice(/* 13*7 + 10 */ 101, 112).map(s => s.trim()).join('');
    QUnit.assert.equal(total, "<td class='nav border total'>Total (6 issues)</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>73.78</td><td class='nav border total'>33</td><td class='nav border total'>48</td><td class='nav border total'>-7.22</td><td class='nav border total'>25.78</td><td class='nav border total'>59%</td>", "total");
    QUnit.assert.equal(lines.length, 13*8 + 10 + 1 /* new line at end of file */, "lines");
});
QUnit.test("Html Export TimeTracking Grouped by Assignee", function() {
    ...
    var row1 = lines.slice(24, 36).map(s => s.trim()).join('');
    QUnit.assert.equal(row1, "<td class='nav border'><a href='/people/aaaa:aaaaaaaa-aaaa-1aaa-aaaa-aaaaaaaaaaaa' title='admin@example.com'>admin</a> (6 issues)</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>&nbsp;</td><td class='nav border'>73.78</td><td class='nav border'>33</td><td class='nav border'>48</td><td class='nav border'>-7.22</td><td class='nav border'>25.78</td><td class='nav border'>59%</td>", "row1");
    var row2 = lines.slice(38, 50).map(s => s.trim()).join('');
    QUnit.assert.equal(row2, "<td class='nav border'>&nbsp;</td><td class='nav border'>Bug</td><td class='nav border'></td><td class='nav border'><a href='/browse/TIME-1'>TIME-1</a></td><td class='nav border'><a href='/browse/TIME-1'>Hocus Focus Problem</a></td><td class='nav border'>Major</td><td class='nav border'>0</td><td class='nav border'>33</td><td class='nav border'>11</td><td class='nav border'>-44</td><td class='nav border'>-11</td><td class='nav border'>25%</td>", "row2");
    var total = lines.slice(/* 14*8 + 10 */ 122, 134).map(s => s.trim()).join('');
    QUnit.assert.equal(total, "<td class='nav border total'>Total (6 issues)</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>&nbsp;</td><td class='nav border total'>73.78</td><td class='nav border total'>33</td><td class='nav border total'>48</td><td class='nav border total'>-7.22</td><td class='nav border total'>25.78</td><td class='nav border total'>59%</td>", "total");
